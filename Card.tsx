    ...
    <div className={styles.stageContainer}>
      ...
      <div className={styles.headerPanel}>
        <div className={styles.statusBadge}>
          ...
          <span>
            ...
            {stageState === 'opened' && 'Tap the shaking card to pull out'}
      ...
      <div className={styles.experienceStage}>
        <div className={getHolderClasses()} onClick={handleHolderClick}>
          ...
          {/* Base Body & Inside Content (Leather Finished) */}
          <div className={`${styles.holderBase} ${styles.leatherTexture}`}>
            <div className={styles.baseStitch} />

            {/* Welcome Banner */}
            <div className={styles.interiorWelcome}>
              <span className={styles.welcomeBadge}>Welcome to the Centre</span>
              <h2 className={styles.welcomeTitle}>LEADS Next Gen Centre</h2>
              <p className={styles.welcomeSub}>M. S. Ramaiah University of Applied Sciences</p>
            </div>
          ...
          <div className={styles.coverLeaf}>
            ...
            {/* Front Side: Midnight Leather + Stitched Edge + Embossed Crest */}
            <div className={styles.coverFront}>
              <div className={styles.coverStitch} />
              
              <div className={styles.embossedLogoContainer}>
                <img src={logoSrc} alt="LEADS Next Gen Centre" className={styles.coverLogo} />
              </div>

              <div className={styles.coverPrompt}>Tap to Open &rarr;</div>
            </div>

            {/* Back Side: Interior Leather Credentials */}
            <div className={styles.coverBack}>
              ...
              <div className={styles.coverBackBody}>
                ...
                <p className={styles.coverBackText}>
                  Ramaiah University of Applied Sciences<br />
                  <strong style={{ color: '#fff' }}>LEADS Next Gen Centre</strong>
                </p>
              </div>
